...
function get_header($source){
	$header = '<div class="centeredDiv" id="topNav">
		<pre><a href="http://stitchcollection.com/" class="journal" id="stitchCollection">StitchCollection</a>		<a href="about_us.php" id="aboutUs" class="about questrial">About Us</a>		<a href="about_you.php" id="aboutYou" class="about questrial">About You</a>		<a href="search.php" class="about questrial">Search Ensemble</a></pre>
	</div>
	<div class="centeredDiv" id="bottomNav">
		<pre class="journal"><a href="index.php" class="bottomLink" >ensemble</a>		<a href="elements.php" class="bottomLink" >elements</a>		<a href="balance.php" class="bottomLink" >balance</a>		<a href="forward.php" class="bottomLink" >forward</a>		<form action= method="POST" style="display: inline"><input type="text" id="emailBar" name="emailBar" placeholder="Join us with your email!"/><input type="submit" id="emailSubmit" name="emailSubmit" value="Sign Up!" /></form></pre>
	</div>';

    $header = str_replace("form action=", "form action=$source", $header);
